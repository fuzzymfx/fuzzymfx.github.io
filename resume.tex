...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \runsubsection{\href{http://squibix.com/}{Squbix Digital}}\descript{| Fullstack blockchain developer}\hfill \location{Bhubaneswar | July 3rd, 2022 – Jan 3rd, 2022}
      \begin{tightemize}
       \item Refactored legacy code-base to React18. Refactored React-Native applications with better UI and implemented offline storage, push notifications, and built internal erp system to monitor attendance and tasks of employees.
