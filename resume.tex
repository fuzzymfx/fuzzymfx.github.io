...
\end{tightemize}
  ...
  \runsubsection{\href{http://ebibil.com/}{E-Bibil Technologies}}\descript{| Front-end developer}\hfill \location{WFH | July 27th, 2021 – Sep 27th, 2021}
      \begin{tightemize}
    \item Collaborated on the light-weight Django web app to integrate with ML models for a smart parking system to recognize the license plate using python and OpenCV for the ANPR system.
