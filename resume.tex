...
A static site generator that renders HTML, rss \& pdf files with search feat., \& custom UI themes. BLOG II is a multi-client blogging platform with token-based authentication. \\
\sectionsep
