...
\section{Experience}
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem
          {Updated the existing codebase to add new features and fix bugs using React, GoogleAppScript, \& NodeJs.}
        \resumeItem
          { Built a chrome extension to import CSVs into Google Sheets using GoogleAppScript.}
      \resumeItemListEnd
