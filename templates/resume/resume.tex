...
\section{Experience}
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem
          {Built a multi-threaded, asynchronous health monitoring service using Rust, and Kafka that handles 10,000+ scraping requests every 10 secs. Optimized and ported the alert mod from Python to Rust to improve performance}
        \resumeItem
