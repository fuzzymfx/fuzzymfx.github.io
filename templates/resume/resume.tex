...
\section{Experience}
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem
          {Collaborated on the Data-Preview component, enhancing data visualization capabilities, which led to a 30\% reduction in data import errors. Implemented robust filters, joins, and v-lookups, resulting in a 40\% increase in data processing efficiency for users conducting ETL operations.}
        \resumeItem
        {Built data pipelines to import data to the Google Spreadsheet, reducing manual data entry efforts by 70\%.}
      \resumeItemListEnd
      \resumeSubheading
      {Asymmetri}{WFH, IN}
