...
\section{Experience}
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem
          {Created the Data-Preview component, enhancing data visualization capabilities, which led to a 30\% reduction in data import errors. Implemented robust filters, joins, and v-lookups, increasing data processing efficiency for users conducting ETL operations.}
        \resumeItem
        {Built sustainable RAG pipelines to convert text to SQL \& no SQL queries, reducing more than 50\% user churn.}
      \resumeItemListEnd
      \resumeSubheading
      {Asymmetri}{WFH, IN}
