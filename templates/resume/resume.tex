  ...
  \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem
          ...
          \resumeItem
          {Building a native GUI app in Rust; to highlight unknown objects present during checkout in LCD counter-top POS.}
      \resumeItemListEnd
  \resumeSubheading
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem
          {Launched the backend infrastructure using NodeJs. Configured optional parameters to switch between different blockchains. Ported the
