...
\section{Experience}
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem
        {Worked on prompt engineering to convert natural languages to SQL \& no SQL queries, reducing user churn.}
      \resumeItemListEnd
      \resumeSubheading
      {Asymmetri}{WFH, IN}
      {Full-stack Developer- Part-time}{June 2022 - July 2023}
      \resumeItemListStart
        \resumeItem
          {Building a robust PDF generator using React and NodeJs. Devised a custom PDF viewer using react-pdf and react-pdf-highlighter.}
      \resumeItemListEnd
    \resumeSubheading
...
\section{Technical Skills}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{\textbf{Libraries/ Frameworks}}
      {MERN, React Native, $\|$ Numpy, Pandas, Sk-Learn, Django, Flutter, Substrate }
