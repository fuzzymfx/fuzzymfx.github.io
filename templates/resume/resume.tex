...
\section{Experience}
  ...
  \resumeSubheading
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem
          {Designed and developed the Squbix Website. Refactored mobile applications with better UI, implemented offline
          storage, push notifications, and created an ERP app to monitor the attendance and tasks of employees.}
        \resumeItem
          {Launched the backend infrastructure using NodeJs. Configured optional parameters to switch between different blockchains. Refactored the
